...
lambda2_subbed = subs(jj_lambda_eye, lambda, lambda2);
unit_vect2 = get_unit_vect(lambda2_subbed);
coeffs2 = coeffs(unit_vect2);

lambda3_subbed = subs(jj_lambda_eye, lambda, lambda3);
unit_vect3 = get_unit_vect(lambda3_subbed);
coeffs3 = coeffs(unit_vect3);


% Todo check our work

q = [coeffs2(1,3), coeffs2(1,2), coeffs2(1,1);...
    coeffs3(1,3), coeffs3(1,2), coeffs3(1,1);...
    -coeffs1(1,3), -coeffs1(1,2), -coeffs1(1,1)];
